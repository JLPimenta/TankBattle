...
import TankImplementation.decorator.ObstacleDecorator;
import TankImplementation.service.TankService;
import TankImplementation.strategy.BasicNeighborStrategy;
...
public class TankArena extends CFase {
    ...
    private void executaCaminho() {
        tank.setNeighborStrategy(new BasicNeighborStrategy());
        tank.setNeighborDecorator(new ObstacleDecorator());
        ArrayList<BlocoCenario> caminho = tank.findPath(matrizBlocos[0][0], matrizBlocos[9][9], matrizBlocos);
    ...
    public void inicializa() {
        criaCena();
        criaMouse();
        tank.criaTank(mouse, matrizBlocos);
    }
